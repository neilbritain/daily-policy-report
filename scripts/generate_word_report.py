...
def get_report_data():
    ...
    return {
        ...
        "policies_3month": [
            {
                "title": "长期政策框架梳理",
                "content": "国家战略层面的数据和算力发展框架（2024-2026）:\n\n1. 数据要素市场化 - 从2024年的数据要素计划启动，到2026年进入标准化建设阶段，国家正在建立完善的数据治理体系和市场机制。\n\n2. 算力基础设施优化 - 国家先后部署了八大算力枢纽节点，到2026年3月底，全国智能算力总规模已达188万PFLOPS，占比超过80%，形成了全国性的算力布局。\n\n3. 人工智能规范发展 - 从2025年网络安全法修订，到2026年个人信息保护专项行动，体现了鼓励创新、防范风险的平衡政策方向。"
            }
        ],
        "trends": "1. 大模型与算力基础设施融合加速 - 预期各省级部门的模数共振实施方案将陆续落地，下半年将看到大量具体项目部署。\n\n2. 数据标准体系加快完善 - 30余项国家标准将在下半年逐步发布，数据管理将从粗放式向精细化转变。\n\n3. 网络安全执法力度加强 - 基于修订后网络安全法的更严厉罚则，相关执法部门将加大检查力度。\n\n4. 人工智能与产业融合深入 - 工业互联网平台与AI技术的融合将进入快速应用阶段，制造业、能源、金融等行业率先部署。\n\n5. 算力与能源协同常态化 - 各地将建立算力与能源协同机制，算力成本波动性增大，用户需建立灵活的采购策略。"
    }
...
def add_section(doc, title, policies):
    ...
    for policy in policies:
        ...
        summary_format = summary.runs[0].font if summary.runs else None
        if summary_format:
